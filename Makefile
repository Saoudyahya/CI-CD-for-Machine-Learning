...
deploy:
	...
	python -c "from huggingface_hub import HfApi; HfApi().upload_folder(folder_path='App', path_in_repo='.', repo_id='YOUR_USERNAME/house-price-predictor', repo_type='space', token='$(HF)')"
